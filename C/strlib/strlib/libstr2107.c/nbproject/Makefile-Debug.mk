...
${OBJECTDIR}/address_of.o: address_of.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/address_of.o address_of.c

${OBJECTDIR}/begins_with_ignore_case.o: begins_with_ignore_case.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/begins_with_ignore_case.o begins_with_ignore_case.c

${OBJECTDIR}/belongs.o: belongs.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/belongs.o belongs.c
...
${OBJECTDIR}/distinct.o: distinct.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/distinct.o distinct.c

${OBJECTDIR}/drop_left.o: drop_left.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/drop_left.o drop_left.c

${OBJECTDIR}/drop_right.o: drop_right.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/drop_right.o drop_right.c
...
${OBJECTDIR}/findlength.o: findlength.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/findlength.o findlength.c

${OBJECTDIR}/index_of.o: index_of.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/index_of.o index_of.c

${OBJECTDIR}/intersect.o: intersect.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/intersect.o intersect.c
...
${OBJECTDIR}/strcopy.o: strcopy.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/strcopy.o strcopy.c

${OBJECTDIR}/wordcount.o: wordcount.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/wordcount.o wordcount.c
